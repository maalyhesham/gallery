...
return (
  <Fragment>
    <CssBaseline />
    <Container sx={{ background: "linear-gradient(89deg,#868b89,#373539)" }} maxWidth="xl">
      <Box sx={{ minHeight: '100vh', paddingBottom: 5 }}>
        ...
        {loading ?
          <LoadingSkeleTon />
          : <Box display={'flex'} flex={4} justifuContent={"center"} alignItems={"start"} flexWrap={"warp"} flexDirection={"row"}>
            {
